defmodule EhsEnforcement.Integrations.Airtable.Get do
    ...
    with(
      ...
      case data do
        ...
        _ ->
          ...
          {:error, %{type: :unexpected_format, message: "Response did not contain records", details: data}}
      end
    else
      {:error, error} ->
  ...
  def get_id(base, table, params \\ %{}) do
    ...
    case get(base, table, params_with_limit) do
      ...
      {:ok, records} ->
        ...
        {:error, %{type: :invalid_response, message: "Unexpected records format", details: records}}
  ...
  """
  def get_with_error_handling(base, table, params, error_handler \\ &default_error_handler/1) when is_function(error_handler, 1) do
