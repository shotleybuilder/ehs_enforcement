defmodule EhsEnforcementWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: EhsEnforcementWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: EhsEnforcementWeb.Router,
        statics: EhsEnforcementWeb.static_paths()
    end
  end
